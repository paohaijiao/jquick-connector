...
public class JQuickConnectorJSonExtractUtil {
    ...
    public static List<JQuickRow> convert(List<Object> objectList) {
        ...
        return objectList.stream().map(JQuickConnectorJSonExtractUtil::convertObjectToRow).filter(obj -> true).collect(Collectors.toList());
    }
