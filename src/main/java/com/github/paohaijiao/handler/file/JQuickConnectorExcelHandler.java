 ...
 * @since 2025/10/26
 */
public class JQuickConnectorExcelHandler extends JQuickConnectorAbsFileBaseHandler implements JQuickConnectorTypeProvider {
    ...
    public JQuickConnectorType getConnectorType() {
        ...
        JQuickConnectorTypeFactory.ConnectorTypeBuilder connectorTypeBuilder = connectorTypeFactory.buildType(JQuickConnectorTypeEnums.EXCEL.getCode(), JQuickConnectorTypeEnums.EXCEL.getName(), JQuickConnectorCategory.FILE);
        ;
        JQuickConnectorType connectorType = connectorTypeBuilder.withAliases(JQuickConnectorTypeEnums.EXCEL.getCode(), JQuickConnectorTypeEnums.EXCEL.getMime()).withMetadata(new JQuickConnectorTypeMetadata("1.0", JQuickConnectorCategory.FILE.getDescription(), JQuickConnectorCategory.FILE.getDescription())).build();
