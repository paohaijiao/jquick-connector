...
@Getter
public enum JQuickConnectorTypeEnums {
    ...
    JQuickConnectorTypeEnums(String code, String name, String mime) {
        this.code = code;
        this.name = name;
        this.mime = mime;
    }

    public static JQuickConnectorTypeEnums codeOf(String code) {
        for (JQuickConnectorTypeEnums type : JQuickConnectorTypeEnums.values()) {
