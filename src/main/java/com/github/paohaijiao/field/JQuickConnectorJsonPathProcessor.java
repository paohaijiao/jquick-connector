 ...
 * @since 2025/10/21
 */
public class JQuickConnectorJsonPathProcessor implements JQuickConnectorProcessor {
    ...
    @Override
    public Object process(JQuickRow row, JQuickConnectorFieldMappingHolder mapping) {
