 ...
 * @since 2025/8/14
 */
public class JQuickConnectorJSonHandler extends JQuickConnectorAbsFileBaseHandler implements JQuickConnectorTypeProvider {
    ...
    public List<JQuickRow> doParse(Path path, JQuickConnectorParsedQuery query) {
        ...
        List<JQuickRow> rows = JQuickConnectorJSonExtractUtil.buildRowsFromJSon(content.toString(), connectorSearchPath);
        return rows;
    }
    ...
    public JQuickConnectorType getConnectorType() {
        ...
        JQuickConnectorTypeFactory.ConnectorTypeBuilder connectorTypeBuilder = connectorTypeFactory.buildType(JQuickConnectorTypeEnums.JSON.getCode(), JQuickConnectorTypeEnums.JSON.getName(), JQuickConnectorCategory.FILE);
        ;
        JQuickConnectorType connectorType = connectorTypeBuilder.withAliases(JQuickConnectorTypeEnums.JSON.getCode(), JQuickConnectorTypeEnums.JSON.getMime()).withMetadata(new JQuickConnectorTypeMetadata("1.0", JQuickConnectorCategory.FILE.getDescription(), JQuickConnectorCategory.FILE.getDescription())).build();
