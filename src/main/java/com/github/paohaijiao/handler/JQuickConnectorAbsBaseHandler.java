...
public abstract class JQuickConnectorAbsBaseHandler implements JQuickConnectorHandler {
     ...
     * @return
     */
    public abstract List<JQuickRow> buildRow(JQuickConnectorParsedQuery query);
