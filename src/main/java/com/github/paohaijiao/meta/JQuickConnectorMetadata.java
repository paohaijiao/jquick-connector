 ...
 */
@Getter
public class JQuickConnectorMetadata {

    private final String type;

    private final JQuickConnectorHandler handler;
    ...
    public JQuickConnectorMetadata(String type, JQuickConnectorHandler handler) {
